...
/// <summary>
/// Result of a registry set operation.
/// </summary>
public enum RegistrySetResult
{
    Success,
    KeyNotFound,
    AccessDenied,
...
public interface IRegistryService
{
    ...
    /// Returns a result indicating success, access denied, or other failure.
    /// </summary>
    RegistrySetResult SetPortName(string pnpDeviceId, string portName, bool dryRun = false);
