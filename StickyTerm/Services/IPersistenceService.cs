...
public interface IPersistenceService
{
    ...
    /// <summary>
    /// Loads device aliases from storage.
    /// </summary>
    Task<IReadOnlyList<DeviceAlias>> LoadAliasesAsync();

    /// <summary>
    /// Saves device aliases to storage.
    /// </summary>
    Task SaveAliasesAsync(IEnumerable<DeviceAlias> aliases);
}
