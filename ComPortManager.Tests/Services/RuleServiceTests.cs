...
namespace ComPortManager.Tests.Services;
...
public class RuleServiceTests
{
    ...
    {
        _registryServiceMock.Setup(r => r.SetPortName(It.IsAny<string>(), "COM10", false)).Returns(true);
    ...
    {
        _registryServiceMock.Setup(r => r.SetPortName(It.IsAny<string>(), It.IsAny<string>(), false)).Returns(false);
    ...
    {
        _registryServiceMock.Setup(r => r.SetPortName(It.IsAny<string>(), It.IsAny<string>(), false)).Returns(true);
